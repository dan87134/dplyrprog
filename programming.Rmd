...
<p>So far I think this paper will be a lot of help to R uses that are pretty good at R
already and have some background in programming. 

<p>But I think it leaves many questions that most R users who want to start using
...
<p>I comment as I read thought the paper... and when I comment I just write down
whatever comes into my head...
because that's what I think a reader may have similar questions pop into their head.
